...
const CartPage = () => {
  return (
            ...
            <div className="flex flex-col gap-4 lg:w-4/12 md:w-6/12">
              ...
              <div className="bg-stone-300 rounded-md px-6 py-2 flex flex-col gap-10">
                <div className="flex justify-between items-center border-b-2 py-8">
                  ...
                  <p className="opacity-60 text-xl">&#8377; 16,999</p>
                </div>
                <div className="flex justify-center items-center">
                  <p>
                    The total subtoatal reflects on the total price of your order on
                    cart. Including all taxes and duties.
                  </p>
                </div>
              </div>
    ...
    //   <img src="../assets/empty-cart.jpg" className="w-full md:w-2/6 mx-auto" />
    ...
    //  <p className='opacity-60'>Looks like you don't have add anything in your cart till now.</p>
    //   <p className='opacity-60'>Go ahead and explore our top categories</p>
    //  </div>
    //   <Link href='/' className="px-6 py-3 hover:opacity-70 rounded-xl bg-black text-white  transform transition-all  duration-300 hover:scale-95">
    //     Continue Shopping
    //   </Link>
    //   </div>
    // </div>
